package com.ut.vrbluetoothterminal.application;
...
import com.ut.vrbluetoothterminal.serialndk.SerialPort;
...
public class AutoCyclingApplication extends Application {
    ...
    private final String permission = "/dev/ttyS1";
    ...
    private void exeShell() {
        changeSerialPortMode(permission, "777");
        openSerialPort(permission);
    }

    public void changeSerialPortMode(String serialPortName, String mode) {
        try {
            Process sh = Runtime.getRuntime().exec(PermissionUtils.getSuPath());
