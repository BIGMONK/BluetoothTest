...
#include "com_ut_vrbluetoothterminal_serialndk_Serial.h"
#include "stdio.h"
#include<fcntl.h>
#include<termios.h>
...
int Serial_fd;
/*
 * Class:     com_ut_vrbluetoothterminal_serialndk_Serial
 * Method:    OpenSerial
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_ut_vrbluetoothterminal_serialndk_Serial_OpenSerial
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_ut_vrbluetoothterminal_serialndk_Serial_SetSerialBaud
 ...
 * Signature: ([SI)I
 */
JNIEXPORT jint JNICALL Java_com_ut_vrbluetoothterminal_serialndk_Serial_ReadSerialBuf
 ...
 * Signature: ([SI)I
 */
JNIEXPORT jint JNICALL Java_com_ut_vrbluetoothterminal_serialndk_Serial_WriteSerialBuf
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_ut_vrbluetoothterminal_serialndk_Serial_CloseSerial
